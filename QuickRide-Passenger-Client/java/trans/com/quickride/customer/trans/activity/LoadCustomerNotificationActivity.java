...
public class LoadCustomerNotificationActivity extends BaseActivity {
	...
	private void setContent(final Intent intent) {
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(this).setTitle("欢迎乘坐").setIcon(R.drawable.ic_menu_more)
				.setMessage(intent.getStringExtra("content"))
				.setPositiveButton(R.string.confirm, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int whichButton) {
						if (null != tcpService) {
							tcpService.respondNofityLoad(intent.getIntExtra("seqNo", 0));

							startActivity(new Intent().setClass(LoadCustomerNotificationActivity.this,
		...
		// .setClass(LoadCustomerNotificationActivity.this,
		// CheckRouteActivity.class).setFlags(
