...
public class MyInviteActivity extends MGestureSwitchPageActivity {
	...
	void initHeaderBar() {
		...
		this.headerTitle.setText(getString(R.string.main_invite_no));
		...
		case PICK_CONTACT:
			...
			if (cursor.moveToFirst()) {
				...
				if (hasPhone.equalsIgnoreCase("1")) {
					Cursor phones = getContentResolver().query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, null, ContactsContract.CommonDataKinds.Phone.CONTACT_ID + " = " + contactData.getLastPathSegment(), null, null);
					...
					if (phoneNoList.size() > 1) {
						new AlertDialog.Builder(this)
								...
								.setSingleChoiceItems(
										phoneNoList.toArray(new String[0]), 0,
